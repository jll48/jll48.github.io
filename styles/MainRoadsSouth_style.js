...
var styleCache_MainRoadsSouth={}
var style_MainRoadsSouth = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_MainRoadsSouth[key]){
        ...
        styleCache_MainRoadsSouth[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_MainRoadsSouth[key]];
